...
import tr from 'src/assets/images/tr.jpg'
                ...
                <div className={`${props.className}-link__thumb`}>
                  {isAmp ? (
                    <div
                      ...
                      style={{
                        backgroundImage: `url("${article?.ogp || tr}")`
                      }}
                    />
                  ) : (
                    <img src={article?.ogp || tr} alt={article?.title} />
                  )}
                </div>
                <span className={`${props.className}-link__info`}>
                  <time>
                    {dayjs(String(article?.date)).format('YYYY-MM-DD')}
                  </time>
